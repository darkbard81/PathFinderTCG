...
export const UI_THEME = {
  ...
  dom: {
    ...
    cardWorkbench: {
      ...
      dividerBorder: '1px solid rgba(158, 207, 170, 0.28)',
    },
    ...
    cardTile: {
      ...
      gap: '12px',
      radius: '6px',
      border: '1px solid rgba(183, 201, 186, 0.42)',
      hoverBorder: '1px solid rgba(191, 238, 197, 0.9)',
      shadow: '0 2px 6px rgba(0, 0, 0, 0.5)',
      selectGlow: '0 0 0 2px rgba(255, 243, 194, 0.9), 0 0 16px rgba(255, 243, 194, 0.45)',
      fallbackBackground: 'radial-gradient(circle at 50% 35%, #1f3a2c, #0d1712)',
      chipBackground: 'rgba(7, 16, 13, 0.86)',
      chipColor: '#fff3c2',
      chipFontScale: '0.105',
      chipPadding: '1px 5px',
      chipRadius: '3px',
    ...
    battlefield: {
      ...
      skillFontSize: '11px',
      skillColor: '#07100d',
      skillBorder: '1px solid rgba(7, 16, 13, 0.55)',
      skillShadow: '0 2px 6px rgba(0, 0, 0, 0.6)',
      skillHealBackground: '#a8e6b2',
      skillDamageBackground: '#ffb0a4',
      skillBuffBackground: '#ffe4a8',
